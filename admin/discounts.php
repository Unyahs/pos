...
<body>       
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="info">
                <div class="head">
                    <span class="heading"> DISCOUNT CODES</span>

                    <button id="myBtn" class="add"> Add Discount </button>
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="../config-admin/add discount.php" method="post">
                                <div class="input-box">
                                    <label for="discount_code">Discount Code:</label>
                                    <input type="text" id="discount_code" name="discount_code" required="required">
                                </div>
                                ...
                                <input type="submit" value="Add New Discount" class="btn">
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php
                                ...
                                $query = mysqli_query($conn, "SELECT * FROM discounts");
                                while($row = mysqli_fetch_array($query)){
                                    //Display all the rows from query
                                    Print "<tr>";
                                        Print "<td data-cell='Discount ID'> " . $row['discount_id'] . " </td>";
                                        Print "<td data-cell='Discount Code'> " . $row["discount_code"] . " </td>";
                                        Print "<td data-cell='Discount Amount'> " . $row["discount_amount"] . "%</td>";
                                        Print '<td class="action" data-cell="Edit"><a href="edit_discount.php?id='.$row['discount_id'].'"><i class="fa-regular fa-pen-to-square"></i></a></td>';
                                        Print '<td class="action" data-cell="Delete"><a href="../config-admin/delete_discount.php?id='.$row['discount_id'].'" onclick="return confirmDelete();"><i class="fa-solid fa-trash"></i></a></td>';
                                    Print "</tr>";
                                }
                            ?>
                        </tbody>
