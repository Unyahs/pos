                ...
                <div class="head">
                    ...
                    <div id="myModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form action="../config-admin/add product.php" method="post">
                                <div class="input-box">
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_array($query)){
                                    ...
                                    Print "<tr>";
                                        ...
                                        Print '<td class="action" data-cell="Delete"><a href="../config-admin/delete_product.php?id='.$row['product_id'].'" onclick="return confirmDelete();"><i class="fa-solid fa-trash"></i></a></td>';
                                    Print "</tr>";
                                }
                            ?>
                        </tbody>
