        ...
        <div class="main_content">
            ...
            <div class="info">
                <div class="product-list">
                    <div class="head">
                        <a href="../makeorder.php" class="back"> <i class="fa-solid fa-arrow-left"></i>  <span class="heading"> Fruiteas</span>  </a>   
                    </div>
                    ...
                    <div class="body">
                        <table>
                            ...
                            <?php
                                ...
                                $query = mysqli_query($conn, "SELECT product_name, price FROM products WHERE category_id ='2' ORDER BY product_name ASC "); //SQL Query
