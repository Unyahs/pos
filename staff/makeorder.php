        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function addToCart(row) {
                ...
                var addPromise = new Promise(function (resolve) {
                    ...
                    var data = 'action=add&productName=' + encodeURIComponent(productName) + '&productPrice=' + productPrice;
                    xhr.onload = function () {
                        resolve();
                    };
                    xhr.send(data);
        ...
        <div class="main_content">
            ...
            <div class="info">
                <div class="category-btns">
                    <a href="makeorder-list/milkteas.php" class="card"> <div>Milkteas</div> </a>
                    <a href="makeorder-list/hot-drinks.php" class="card"> <div>Hot Drinks</div> </a>
                    <a href="makeorder-list/non-coffee.php" class="card"> <div>Non-Coffee / Milk</div> </a>
                    <a href="makeorder-list/iced-Coffee.php" class="card"> <div>Iced-Coffee</div> </a>
                    <a href="makeorder-list/fruit-tea.php" class="card"> <div>Fruit Tea</div> </a>
                    <a href="makeorder-list/lemonades.php" class="card"> <div>Lemonades</div> </a>
                    <a href="makeorder-list/add-ons.php" class="card"> <div>Add Ons</div> </a>
                    <a href="makeorder-list/add-ons-coffee.php" class="card"> <div>Cofee Add Ons</div> </a>
                </div>
